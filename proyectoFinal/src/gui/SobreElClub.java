...
public class SobreElClub extends JDialog {
	...
	public SobreElClub() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Alumno", TitledBorder.LEFT, TitledBorder.TOP, null, Color.GRAY));
		...
		txtpnAutorRalMoreno.setText("Autor: Ra\u00FAl Moreno Povedano\r\nVersion: 1.0\r\nCurso: 1\u00BA DAW\r\nAsignatura: Programaci\u00F3n\r\nA\u00F1o: 2015");
		txtpnAutorRalMoreno.setFont(new Font("Tahoma", Font.PLAIN, 11));
		txtpnAutorRalMoreno.setBackground(SystemColor.menu);
		
		JPanel panel_1 = new JPanel();
		panel_1.setLayout(null);
		panel_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Club", TitledBorder.LEADING, TitledBorder.TOP, null, Color.GRAY));
		panel_1.setBounds(104, 11, 241, 85);
		contentPanel.add(panel_1);
		
		JTextPane txtpnNombreCdModas = new JTextPane();
		txtpnNombreCdModas.setText("Nombre: C.D. Modas Levante\r\nLocalidad: C\u00F3rdoba\r\nA\u00F1o de Fundaci\u00F3n: 1988");
