...
public class Ayuda extends JDialog {
	...
	public Ayuda() {
		...
		mntmGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				panelMensaje.setVisible(true);
				panelMensaje.setText("<h2 text-align: justify>Guardar un archivo. Si al guardar el archivo existe un archivo con el mismo nombre, preguntará si deseamos sobreescribirlo.</h2>");
			}
		});
		...
		mntmGuardarComo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panelMensaje.setVisible(true);
				panelMensaje.setText("<h2 text-align: justify>Guardar el fichero con otro nombre distinto.</h2>");
			}
		});
		...
		mntmSalir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panelMensaje.setVisible(true);
				panelMensaje.setText("<h2 text-align: justify>Salir del programa. Si el archivo en uso ha sido modificado, te pedirá si deseas guardar los cambios antes de salir.</h2>");
			}
		});
		...
		mntmVerLaAyuda.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panelMensaje.setVisible(true);
				panelMensaje.setText("<h2 text-align: justify>Muestra al usuario un pequeño manual acerca de lo que va a encontrarse en el programa.</h2>");
			}
		});
		...
		mntmAcercaDelClub.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panelMensaje.setVisible(true);
				panelMensaje.setText("<h2 text-align: justify>Muestra una breve reseña del Club y el Alumno que ha llevado a cabo el programa.</h2>");
			}
		});
